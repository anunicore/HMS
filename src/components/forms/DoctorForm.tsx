...
import { doctorSchema, DoctorSchema } from "@/lib/formValidationSchemas";
import { useFormState } from "react-dom";
import { createDoctor, updateDoctor } from "@/lib/actions";
...
const DoctorForm = ({
  ...
  const { specialties } = relatedData;
  console.log("____A", relatedData);
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.specialties?.message && (
            <p className="text-xs text-red-400">
              {errors.specialties.message.toString()}
            </p>
          )}
        </div>
        <CldUploadWidget
